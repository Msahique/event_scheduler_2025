...
LOCK TABLES `token_details` WRITE;
/*!40000 ALTER TABLE `token_details` DISABLE KEYS */;
INSERT INTO `token_details` VALUES (1235,'test','test entity','superadmin','abcdefgh123456789',NULL,NULL,NULL,NULL,NULL);
