...
//{"controls": [{"tag": "view", "name": "<i class='fa fa-eye' ></i>", "type": "button", "class": "btn btn-info btn-xs my-xs-btn", "roles": ["Admin"], "tooltip": "this is a test description", "function": "view_document()"},{"tag": "create", "name": "<i class='fa fa-plus'></i> ", "type": "button", "class": "btn btn-success btn-xs my-xs-btn", "roles": ["Admin"], "tooltip": "this is a test description", "function": "Registration_modal()"}, {"tag": "print", "name": "<i class='fa fa-print'></i> ", "type": "button", "class": "btn btn-primary btn-xs my-xs-btn", "roles": ["Admin"], "tooltip": "this is a test description", "function": "print_document()"}, {"tag": "download", "name": "<i class='fa fa-download'></i> ", "type": "button", "class": "btn btn-primary btn-xs my-xs-btn", "roles": ["Admin"], "tooltip": "Download document", "function": "download_document()"}, {"tag": "print", "name": "<i class='bi bi-pencil-fill'><i> ", "type": "button", "class": "btn btn-warning btn-sm", "roles": ["Admin"], "tooltip": "this is a test description", "function": "edit_data()"}, {"tag": "print", "name": "<i class='bi bi-trash-fill'></i> ", "type": "button", "class": "btn btn-danger btn-sm", "roles": ["Admin"], "tooltip": "this is a test description", "function": "delete_data()"}, {"tag": "chartTemplates", "name": "Entity Config", "type": "select", "roles": ["Admin"], "options": [], "tooltip": "this is a test description", "function": "getChartTemplate", "textContent": "Chart Templates"}, {"tag": "items", "name": "Entity Config", "type": "select", "roles": ["Admin"], "helper": "none", "options": ["Role Registry", "Affiliation Registry", "Resource Category", "Resource Registry", "Event Category", "Message Template", "Application Registry", "Entity log"], "tooltip": "this is a test description", "trigger": "none", "textContent": "Items"}, {"tag": "entriesPerPage", "name": "EntriesPerPage", "type": "select", "roles": ["Admin", "Approver", "User"], "options": [1, 5, 10, 25, 50, 100], "tooltip": "this is a test description", "textContent": "Rows/Page"}]}
